...
import com.cwlib.pathsafe.database.DatabaseHelper;
import com.cwlib.pathsafe.database.DatabaseManager;
import com.cwlib.pathsafe.database.dao.OTPDao;
import com.cwlib.pathsafe.listeners.OnAuthListener;
import com.cwlib.pathsafe.listeners.QueryExecutor;
import com.cwlib.pathsafe.beans.AccountInfo;
import com.cwlib.pathsafe.beans.GenerateOTP;
...
import com.cwlib.pathsafe.rest.ttlock.RetrofitAPIManager;
...
public class JKHelper extends Application implements OnResponse<UniverSelObjct> {
    ...
    public void auth(int i, Activity ctx, OnAuthListener listnr) {
        ...
        mProgressBar.setTitle("PathSafe");
